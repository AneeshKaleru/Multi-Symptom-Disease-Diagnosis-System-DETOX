...
w2 = Label(root, justify=LEFT, text="Contributors: ABHINAV,ANEESH", fg="Pink", bg="Ivory")
w2.config(font=("Times",30,"bold italic"))
...
t2=Label(root,font=("Times",15,"bold italic"),text="Random Forest",height=1,bg="Purple"
         ,width=40,fg="white",textvariable=pred1,relief="sunken").grid(row=17, column=1, padx=10)
...
# Assuming you have X (input features) and y (target variable) defined
